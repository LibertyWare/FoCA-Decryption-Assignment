...
{   char temp_char;						// Character temporary store
   ...
   encrypt_20:
			...
			rol cl, 1					// the bits of the temp character are rotated left												
			rol cl, 1					// and then rotated left again								
...
void decrypt_chars (int length, char EKey)
{
	...
	for (int i = 0; i < length; i++)		// Decrypt characters one at a time
	{
		...
		__asm {
				...
				add esp, 8					// clear the stack
				mov		temp_char, al		// move encrypted character (stored in the last 8 bits of EAX) to 'temp_char'
				/*---conversion to lower case old method---
				...
				skipConversion:		
				*/
				or temp_char, 60h			//---conversion to lower case new method---
